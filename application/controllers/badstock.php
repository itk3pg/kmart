...
class Badstock extends CI_Controller {
	public function __construct(){
		parent::__construct();
		
		$this->load->model('user_model');
		$this->load->model('badstock_model');
	...
	public function index(){
		...
		$this->load->view('badstock/home');
		$this->load->view('general/footer');
	}
	
	public function getdatabadstock(){
		$Databs = $this->badstock_model->getDataBadStock($_POST);
		
		$bukti = "";
		$html = "<table class=\"table table-striped table-bordered table-hover\" id=\"dataTables-bs\">
                    <thead>
                        <tr>
							<th>BUKTI</th>
                       		<th>TANGGAL</th>
	...
	public function simpanbadstock(){
		if($_POST['kwt'] > 0){
			$this->badstock_model->SimpanBadStock($_POST);
	...
	public function hapusbadstock(){
		$this->badstock_model->HapusBadStock($_POST);

		$DataBarangbs = $this->badstock_model->getDataBarangBadStockHapus($_POST);
	...
	public function getdatabarangbadstock(){
		$DataBarangbs = $this->badstock_model->getDataBarangBadStock($_POST);
	...
	public function cetakbs(){
		$DataBarangot = $this->badstock_model->getDataBarangBadStock($_GET);
		...
		$html .= "<table>
					<tr>
						...
						<td align=\"right\">Bad Stock (BS)</td>
					</tr>
					<tr>
