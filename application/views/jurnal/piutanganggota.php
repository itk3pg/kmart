<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Jurnal Kredit Anggota (PG)</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-lg-12">
            ...
            <div id="table-piutanganggota"></div>
		</div>
	</div>
</div>
<script>
	...
	function LoadDataMutasi(){
		...
		if(bulan <= 4 && tahun <= 2016){
			alert("Jurnal tidak tersedia");
		}else{
			$("#progres-main").show();
			$.ajax({
				type: "POST",
				url: "<?= base_url('index.php/jurnal/piutanganggota/getdatapiutanganggota') ?>",
				data: "bulan="+bulan+"&tahun="+tahun,
				success: function(msg){
					$("#table-piutanganggota").html(msg);
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/jurnal/piutanganggota/cetakdatapiutanganggota?') ?>bulan='+bulan+'&tahun='+tahun,'_blank');
	}
</script>