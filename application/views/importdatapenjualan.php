...
<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 class="page-header">Import Data Penjualan</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
		<div class="col-lg-12">
	    	<div id="message"></div>
	    	<form id="myForm" action="<?php echo base_url(); ?>index.php/importdatapenjualan/importfile" method="post" enctype="multipart/form-data">
				<table width="100%">
					<tr>
