<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Data Barang Tidak Terjual</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
...
<script>
	...
	function LoadDataMutasi(){
		...
		$.ajax({
			type: "POST",
			url: "<?= base_url('index.php/laporan/barangtidakterjual/getdatabarangtidakterjual') ?>",
			data: "toko_kode="+toko_kode+"&tanggal_awal="+tanggal_awal+"&tanggal_akhir="+tanggal_akhir,
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/barangtidakterjual/cetakdatabarangtidakterjual?') ?>toko_kode='+toko_kode+'&nama_toko='+nama_toko+'&tanggal_awal='+tanggal_awal+'&tanggal_akhir='+tanggal_akhir,'_blank');
	}
</script>