<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Data Penjualan Per Barang</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
			...
			<table style="float: right;">
				<tr>
					...
					<td>
						Kategori:
						<div class="form-group input-group">
							<select class="form-control" style="width: 200px;" name="mutasi_kategori" id="mutasi_kategori">
								<?php
...
<script>
	...
	function LoadDataMutasi(){
		...
		var kategori = $("#mutasi_kategori").val();
		...
		$.ajax({
			type: "POST",
			url: "<?= base_url('index.php/laporan/penjualanperbarang/getdatapenjualanperbarang') ?>",
			data: "toko_kode="+toko_kode+"&kategori="+kategori+"&barang_kode="+barang_kode+"&tanggal_awal="+tanggal_awal+"&tanggal_akhir="+tanggal_akhir,
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/penjualanperbarang/cetakdatapenjualanperbarang?') ?>toko_kode='+toko_kode+'&nama_toko='+nama_toko+'&kategori='+kategori+'&barang_kode='+barang_kode+'&tanggal_awal='+tanggal_awal+'&tanggal_akhir='+tanggal_akhir,'_blank');
	}
</script>