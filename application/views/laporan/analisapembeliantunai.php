<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Analisa Pembelian Tunai & Kasbank</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-lg-12">
            ...
            <div id="table-pembeliantunai"></div>
		</div>
	</div>
</div>
<script>
	...
	function LoadDataMutasi(){
		...
		if(bulan <= 7 && tahun <= 2015){
			...
			$.ajax({
				type: "POST",
				url: "<?= base_url('index.php/laporan/analisapembeliantunai/getdatapembeliantunai') ?>",
				data: "bulan="+bulan+"&tahun="+tahun,
				success: function(msg){
					$("#table-pembeliantunai").html(msg);
	...
	function AktifkanKasbankPembelianTunai(bukti){
		$.ajax({
			type: "POST",
			url: "<?= base_url('index.php/laporan/analisapembeliantunai/aktifkankasbank') ?>",
			data: "bukti="+bukti,
			success: function(msg){
				LoadDataMutasi();
			}
	...
	function InsertKasbankPembelianTunai(param){
		$.ajax({
			type: "POST",
			url: "<?= base_url('index.php/laporan/analisapembeliantunai/insertkasbank') ?>",
			data: "data="+param,
			success: function(msg){
				LoadDataMutasi();
			}
	...
	/*function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/penjualanbulanan/cetakpenjualanbulanan?') ?>bulan='+bulan+'&tahun='+tahun,'_blank');
	}*/
</script>