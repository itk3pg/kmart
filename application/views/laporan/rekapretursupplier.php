<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Rekap Retur Supplier</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
		<div class="col-lg-12">
			<table style="float: right;">
				<tr>
					<td>
						<input type="checkbox" checked name="mutasi_mode" id="mutasi_mode" /> Per Supplier
					</td>
					<td valign="middle">&nbsp;-&nbsp;</td>
					<td>
						Bulan:
	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-lg-12">
            ...
            <div id="table-rekapretursupplier"></div>
		</div>
	</div>
</div>
<script>
	...
	function LoadDataMutasi(){
		...
		var mode = "all";
		if($("#mutasi_mode").is(":checked")){
			mode = "supplier";
		}
		
		if(bulan <= 4 && tahun <= 2016){
			alert("Laporan tidak tersedia");
		}else{
			$("#progres-main").show();
			$.ajax({
				type: "POST",
				url: "<?= base_url('index.php/laporan/rekapretursupplier/getrekapretursupplier') ?>",
				data: "bulan="+bulan+"&tahun="+tahun+"&mode="+mode,
				success: function(msg){
					$("#table-rekapretursupplier").html(msg);
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/rekapretursupplier/cetakrekapretursupplier?') ?>bulan='+bulan+'&tahun='+tahun+'&mode='+mode,'_blank');
	}
</script>