<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Kartu Piutang</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-lg-12">
            ...
            <div id="table-rincianpiutang"></div>
		</div>
	</div>
</div>
<script>
	...
	function LoadDataMutasi(){
		...
		if(bulan <= 7 && tahun <= 2015){
			...
			$.ajax({
				type: "POST",
				url: "<?= base_url('index.php/laporan/rincianpiutang/getrincianpiutang') ?>",
				data: "bulan="+bulan+"&tahun="+tahun+"&toko_kode="+toko_kode,
				success: function(msg){
					$("#table-rincianpiutang").html(msg);
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/rincianpiutang/cetakrincianpiutang?') ?>bulan='+bulan+'&tahun='+tahun+'&toko_kode='+toko_kode,'_blank');
	}
</script>