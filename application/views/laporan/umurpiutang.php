<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Umur Piutang</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
				...
				<tr>
					...
					<td>
						...
						<div class="form-group input-group">
							...
							<input type="text" value="<?= date('Y-m-d'); ?>" name="mutasi_tanggal" id="mutasi_tanggal" class="form-control">
						</div>
					</td>
					<td>&nbsp;&nbsp;</td>
					<td>
	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-lg-12">
            ...
            <div class="table-responsive" id="table-umurpiutang"></div>
		</div>
	</div>
</div>
<script>
	...
	function LoadDataMutasi(){
		...
		//}else{
			...
			$.ajax({
				type: "POST",
				url: "<?= base_url('index.php/laporan/umurpiutang/getumurpiutang') ?>",
				data: "tanggal="+tanggal+"&toko_kode="+toko_kode,
				success: function(msg){
					$("#table-umurpiutang").html(msg);
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/umurpiutang/cetakumurpiutang?') ?>tanggal='+tanggal+'&toko_kode='+toko_kode+'&nama_toko='+nama_toko,'_blank');
	}
</script>