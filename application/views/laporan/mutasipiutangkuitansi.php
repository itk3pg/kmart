<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Mutasi Kuitansi Piutang </h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-lg-12">
            ...
            <div id="table-piutangkuitansi"></div>
		</div>
	</div>
</div>
<script>
	...
	function LoadDataMutasi(){
		...
		if(bulan <= 4 && tahun <= 2016){
			...
			$.ajax({
				type: "POST",
				url: "<?= base_url('index.php/laporan/mutasipiutangkuitansi/getpiutangkuitansi') ?>",
				data: "bulan="+bulan+"&tahun="+tahun+"&toko_kode="+toko_kode,
				success: function(msg){
					$("#table-piutangkuitansi").html(msg);
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/mutasipiutangkuitansi/cetakpiutangkuitansi?') ?>bulan='+bulan+'&tahun='+tahun+'&toko_kode='+toko_kode,'_blank');
	}
</script>