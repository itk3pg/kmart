<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Data Mutasi Cash Budget</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
...
<script>
	...
	function LoadDataMutasi(){
		...
		$.ajax({
			type: "POST",
			url: "<?= base_url('index.php/laporan/mutasicashbudget/getmutasicashbudget') ?>",
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/mutasicashbudget/cetakmutasicashbudget?') ?>kd_kb='+kd_kb+'&tanggal_awal='+tanggal_awal+'&tanggal_akhir='+tanggal_akhir+'&unit_kode='+unit_kode+'&nama_kb='+nama_kb+'&nama_toko='+nama_toko,'_blank');
	}
</script>