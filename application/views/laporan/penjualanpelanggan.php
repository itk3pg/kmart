<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Data Penjualan Per Pelanggan</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
...
<script>
	...
	function LoadDataMutasi(mode){
		...
		if(bulan <= 7 && tahun <= 2015){
			...
			$.ajax({
				type: "POST",
				url: "<?= base_url('index.php/laporan/penjualanpelanggan/getpenjualanpelanggan') ?>",
	...
	function CetakDataMutasi(mode){
		...
		window.open('<?= base_url('index.php/laporan/penjualanpelanggan/cetakpenjualanpelanggan?') ?>bulan='+bulan+'&tahun='+tahun+"&mode="+mode,'_blank');
	}
</script>