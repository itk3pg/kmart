...
<script>
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/transaksipenjualan/cetaktransaksipenjualan?') ?>tanggal_awal='+tanggal_awal+'&tanggal_akhir='+tanggal_akhir+"&toko_kode="+toko_kode+"&kasir_kode="+kasir_kode,'_blank');
	}
</script>