<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Rekap Hutang Instansi</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
...
<script>
	...
	function LoadDataMutasi(kd_kb, container){
		...
		$.ajax({
			type: "POST",
			url: "<?= base_url('index.php/laporan/rekaphutanginstansi/getrekaphutanginstansi') ?>",
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/rekaphutanginstansi/cetakrekaphutanginstansi?') ?>tanggal_awal='+tanggal_awal+'&tanggal_akhir='+tanggal_akhir+'&toko_kode='+toko_kode,'_blank');
	}
</script>