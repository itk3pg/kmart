<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Data Penjualan Non Anggota</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
...
<script>
	...
	function LoadDataMutasi(){
		...
		if(bulan <= 7 && tahun <= 2015){
			...
			$.ajax({
				type: "POST",
				url: "<?= base_url('index.php/laporan/rekappenjualannonanggota/getrekappenjualan') ?>",
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/rekappenjualannonanggota/cetakrekappenjualan?') ?>bulan='+bulan+'&tahun='+tahun+"&toko_kode="+toko_kode+"&nama_toko="+nama_toko,'_blank');
	}
</script>