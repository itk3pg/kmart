<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Laporan Omzet dan PPN Keluaran</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
...
<script>
	...
	function LoadDataMutasi(){
		...
		if(bulan <= 4 && tahun <= 2016){
			...
			$.ajax({
				type: "POST",
				url: "<?= base_url('index.php/laporan/omzetppn/getdataomzetppn') ?>",
				data: "bulan="+bulan+"&tahun="+tahun+"&toko_kode="+toko_kode,
				success: function(msg){
					$("#table-omzetppn").html(msg);
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/omzetppn/cetakdataomzetppn?') ?>bulan='+bulan+'&tahun='+tahun+"&toko_kode="+toko_kode+"&nama_toko="+nama_toko,'_blank');
	}
</script>