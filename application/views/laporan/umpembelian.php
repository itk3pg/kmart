<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Mutasi Uang Muka Pembelian</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
	...
	<div class="row" style="margin-top: 10px;">
		<div class="col-lg-12">
            ...
            <ul class="nav nav-tabs">
               	<li class="active"><a href="#tab_mutasi_umpembelianbarang" data-toggle="tab">UM Pembelian Barang</a>
                </li>
                <li><a href="#tab_mutasi_umpembelianjasa" data-toggle="tab">UM Pembelian Jasa</a>
                </li>
            </ul>
            <div class="tab-content">
            	<div class="tab-pane fade in active" id="tab_mutasi_umpembelianbarang">
            		
            	</div>
            	<div class="tab-pane fade" id="tab_mutasi_umpembelianjasa">
...
<script>
	...
	function LoadDataMutasi(kd_cb, container){
		...
		if(bulan <= 7 && tahun <= 2015){
			...
			$.ajax({
				type: "POST",
				url: "<?= base_url('index.php/laporan/getumpembelian') ?>",
				data: "bulan="+bulan+"&tahun="+tahun+"&kd_cb="+kd_cb,
	...
	function LoadAllDataMutasi(){
		LoadDataMutasi("2921", "tab_mutasi_umpembelianbarang");
		LoadDataMutasi("2951", "tab_mutasi_umpembelianjasa");
	}
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/download_excel/getumpembelian?') ?>bulan='+bulan+'&tahun='+tahun,'_blank');
	}
</script>