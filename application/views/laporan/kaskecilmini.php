<div id="page-wrapper">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 style="margin-top: 15px;" class="page-header">Data Biaya Operasional</h1>
	    </div>
	    <!-- /.col-lg-12 -->
	</div>
	<div class="row">
					...
					<td style="width: 200px;">
						...
						<div class="form-group input-group">
							...
							<select style="width: 150px;" class="form-control" name="search_toko_kode" id="search_toko_kode">
								...
								<option value="VO0003">GELURAN</option>
								<option value="VO0004">GKB</option>
								<option value="VO0005">PANJUNAN</option>
								<option value="VO0006">DC</option>
...
<script>
	...
	function LoadDataMutasi(){
		...
		$.ajax({
			type: "POST",
			url: "<?= base_url('index.php/laporan/kaskecilmini/getdatakaskecilmini') ?>",
	...
	function CetakDataMutasi(){
		...
		window.open('<?= base_url('index.php/laporan/kaskecilmini/cetakkaskecilmini?') ?>nama_toko='+nama_toko+'&bulan='+bulan+'&tahun='+tahun+'&toko_kode='+toko_kode,'_blank');
	}
</script>